...
# # Production
# DATABASE_URL = "mysql+pymysql://fastapi_prod_user:StrongProdPass%40123@<VPS_IP>:3306/fastapi_production"

# # Development
# DATABASE_URL = "mysql+pymysql://fastapi_dev_user:StrongDevPass%40123@<VPS_IP>:3306/fastapi_development"
